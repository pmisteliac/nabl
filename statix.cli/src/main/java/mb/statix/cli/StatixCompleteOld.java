...
import mb.statix.codecompletion.TermCompleterOld;
...
public final class StatixCompleteOld {

    private static final ILogger log = LoggerUtils.logger(StatixCompleteOld.class);

    private final Statix STX;
    private final Spoofax spoofax;
    private final IContext context;

    public StatixCompleteOld(Statix stx, Spoofax spoofax, IContext context) {
        this.STX = stx;
    ...
    public void run(String file) throws MetaborgException, InterruptedException {
        ...
        final TermCompleterOld completer = new TermCompleterOld(spec);
        log.info("Completing...");
