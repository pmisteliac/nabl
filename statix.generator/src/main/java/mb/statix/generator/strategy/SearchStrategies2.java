...
public final class SearchStrategies2 {
    ...
    public static <I extends SearchState, O extends SearchState> Single<I, O> single(SearchStrategy<I, O> ss) {
    ...
    public static Fix fix2(SearchStrategy<SearchState, SearchState> search,
    ...
    public static <I extends SearchState> Try<I> try_(SearchStrategy<I, I> search) {
        return new Try<>(search);
    }

    public static <C extends IConstraint> Select<C> select(Mode mode, Class<C> cls, Predicate1<C> include) {
    ...
    public static <C extends IConstraint> Select<C> select(Mode mode, Class<C> cls,
    ...
    public static Expand expand(Mode mode, SetMultimap<String, Rule> rules) {
    ...
    public static Expand expand(Mode mode, Function2<Rule, Long, Double> ruleWeight, SetMultimap<String, Rule> rules) {
    ...
    public static <I extends SearchState, O extends SearchState> Debug<I, O> debugStates(SearchStrategy<I, O> s, ILogger log, String prefix) {
